        ...
        {data.data.data.map(pedido =>(
          <div key={pedido.id} className='p-5 bg-white shadow space-y-2 border-b'>
            ...
            {pedido.productos.map(producto => (
                <div key={producto.id} className='border-b border-b-slate-200 last-of-type:border-none py-5'>
            ...
            <button type="button" className= " bg-indigo-600 hover:bg-indigo-800 px-5 py-2 rounded font-bold text-white text-center w-full cursor-pointer"
